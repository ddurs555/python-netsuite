...
def update_multiple_items(records):
    return update_multiple(records)

def async_update_multiple_items(records):
    return async_update_multiple(records)
